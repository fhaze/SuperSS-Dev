...
DIRSAVEPRROGRAM := ./Auth\ Server

# The build folder, for all generated output. This should normally be included
# in a .gitignore rule
BUILD_FOLDER := output-as-$(CURRENT_OBJDIR_PREFIX)

# my addiction
CFILES := \
	../Auth|Server/Auth|Server/Auth|Server.cpp \
	...
	../Auth|Server/PACKET/packet_func_as.cpp \
	../Projeto|IOCP/DATABASE/database.cpp \
	../Auth|Server/SESSION/player_manager.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_new_auth_server_key.cpp \
	../Auth|Server/SESSION/player.cpp \
	...
	../Auth|Server/PANGYA_DB/cmd_shutdown_info.cpp \
	../Projeto|IOCP/UTIL/iff.cpp \
	../Auth|Server/Auth|Server/auth_server.cpp \
	...
	../Projeto|IOCP/UNIT/unit.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_logon_check.cpp \
	../Auth|Server/TYPE/player_info.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_insert_block_ip.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_auth_server_key.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_insert_block_mac.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_update_auth_server_key.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_auth_key_login_info.cpp \
	../Auth|Server/PANGYA_DB/cmd_command_info.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_save_nick.cpp \
	../Auth|Server/PANGYA_DB/cmd_guild_ranking_update_time.cpp \
	../Projeto|IOCP/PANGYA_DB/cmd_auth_key_game.cpp \
	../Auth|Server/PANGYA_DB/cmd_update_guild_ranking.cpp \
	...
	../Auth|Server/PANGYA_DB/cmd_notice_info.cpp \
	...
	../Auth|Server/PANGYA_DB/cmd_ticker_info.cpp \
	../Auth|Server/PANGYA_DB/cmd_update_command.cpp \
	../Projeto|IOCP/THREAD|POOL/threadpl_unit.cpp
