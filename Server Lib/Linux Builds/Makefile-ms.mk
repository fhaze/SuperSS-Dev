...
CXXLINK := -Wl,--export-dynamic -pthread -lg -ldl `pkg-config --libs libzip` `pkg-config --libs mysqlclient` -lodbc -lcrypto `pkg-config --libs glib-2.0` -lhiredis
...
DIRSAVEPRROGRAM := ./Message\ Server

# The build folder, for all generated output. This should normally be included
# in a .gitignore rule
BUILD_FOLDER := output-ms-$(CURRENT_OBJDIR_PREFIX)

# my addiction
CFILES := \
	../Message|Server/Message|Server/Message|Server.cpp \
	../Message|Server/Message|Server/message_server.cpp \
	...
	../Message|Server/TYPE/player_info.cpp \
	../Message|Server/SESSION/player.cpp \
	../Message|Server/SESSION/player_manager.cpp \
	../Message|Server/PACKET/packet_func_ms.cpp \
	../Message|Server/PANGYA_DB/cmd_add_friend.cpp \
	../Message|Server/PANGYA_DB/cmd_delete_friend.cpp \
	../Message|Server/PANGYA_DB/cmd_friend_info.cpp \
	../Message|Server/PANGYA_DB/cmd_player_info.cpp \
	../Message|Server/PANGYA_DB/cmd_update_friend.cpp \
	../Message|Server/GAME/friend_manager.cpp \
